<?PHP
	...
	$sql = "SELECT * FROM user WHERE username='$teman'";
...
<div class='w3-row w3-card-4 w3-theme-dark w3-theme-padding'>
	<div class='w3-col w3-padding l3 m5 s6'>
		...
		<div class='w3-container w3-center'>
			<input class='w3-btn lb-border' type='submit' name='Ikuti' value="Ikuti">
			<input class='w3-btn lb-border' type='submit' name='Berhenti' value="Berhenti">
			<a class='w3-btn lb-border' href='pesan/buat&kepada=<?PHP echo $_GET['teman'];?>'>Kirim Pesan</a>
		</div>
	</div>
